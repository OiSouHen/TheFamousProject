...
function CheckPolice()
	return LocalPlayer["state"]["PMERJ"] or LocalPlayer["state"]["BOPE"] or LocalPlayer["state"]["PCERJ"] or LocalPlayer["state"]["PRF"] or LocalPlayer["state"]["PF"] or LocalPlayer["state"]["BPCHQ"]
end