...
local Services = {
	{
		["Permission"] = "Policia",
		["Coords"] = vec3(-810.36,-1235.05,6.86),
		["Distance"] = 2.0
	},{
		["Permission"] = "Policia",
		["Coords"] = vec3(-1103.05,-829.3,14.27),
		["Distance"] = 2.0
	},{
		["Permission"] = "Paramedico",
		["Coords"] = vec3(-1259.06,325.39,65.48),
		["Distance"] = 2.0
	},{
		["Permission"] = "Mecanico",
		["Coords"] = vec3(-1071.89,-2090.29,13.26),
		["Distance"] = 2.0
	}
}
-----------------------------------------------------------------------------------------------------------------------------------------
...
RegisterCommand("PlayerFunctions",function()
	...
	if not LocalPlayer["state"]["Commands"] and not LocalPlayer["state"]["Handcuff"] and not LocalPlayer["state"]["Prison"] and not Dynamic and not IsPauseMenuActive() and GetEntityHealth(Ped) > 100 then
		...
		if LocalPlayer["state"]["Admin"] then
			exports["dynamic"]:AddMenu("Administração","Todas as funções administrativas.","admin")
			exports["dynamic"]:AddButton("Prender","Adicionar ficha criminal.","prison:Create","","admin",true)
		end
