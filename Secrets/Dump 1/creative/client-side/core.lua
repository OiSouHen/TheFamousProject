...
local Blips = {
	...
	{ -1271.56,321.18,66.08,80,2,"UPA 24HRS",0.5 },
	...
	{ -1104.98,-832.89,22.28,60,18,"Departamento Policial",0.6 },
	{ -810.36,-1235.05,6.86,60,18,"Departamento Policial",0.6 },
	...
	{ -1105.51,-2089.42,13.26,402,1,"SRT Motors",0.7 },
	...
	{ 3087.1,2090.62,7.48,836,4,"Praia de Nudismo",0.6 },
	{ -1702.15,-837.0,11.22,176,42,"Parque Público",0.6 },
	{ -1139.26,-1707.87,6.13,304,4,"Beach Club",0.6 },
	{ -1201.3,-1569.09,4.6,311,62,"Academia",0.6 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- TELEPORT
-----------------------------------------------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------------------------------------------------
local Alphas = {
	{ vec3(-2026.53,-1460.38,5.34),200,31,150.0 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- ISLAND
-----------------------------------------------------------------------------------------------------------------------------------------
...
CreateThread(function()
	while true do
		...
		for _,Vehicle in pairs(GetGamePool("CVehicle")) do
			if (NetworkGetEntityOwner(Vehicle) == -1 or NetworkGetEntityOwner(Vehicle) == PlayerId()) and not NetworkGetEntityIsNetworked(Vehicle) and GetVehicleNumberPlateText(Vehicle) ~= "CONNECTS" then
				DeleteEntity(Vehicle)
			end
		end
